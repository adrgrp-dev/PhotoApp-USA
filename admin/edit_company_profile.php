...
<?php if(@$_REQUEST['first']) { ?><div class="col-md-12"><h5 align="center" id="label_add_company_profile" style="color:#006600!important;font-size:13px;">Welcome to ADR's Photo App!<br />Step #1 of 2 : Fill out the Company profile</h5></div> <?php } ?>
...
<?php
$city1=mysqli_query($con,"select cities from usa_states_cities");
while($city=mysqli_fetch_array($city1))
{
?>
