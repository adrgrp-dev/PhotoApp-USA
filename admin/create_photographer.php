...
<?php include "header.php";  ?>
	<div class="bgimage3" data-sub-height="238">
            <div class="row">
                ...
                <div class="col-md-6">
  						...
  						<div class="col-md-6">
  						 ...
  						 <div class="col-md-6">
                                  ...
                                  <input id="zip" name="zip" placeholder="Zip code" type="text" maxlength="12" autocomplete="off" class="form-control form-value" required="" value="<?php echo $get_profile1['postal_code']; ?>">
                              </div>
