  ...
  xhttp.send();
	...
	$("#show"+id_to_show_hide).hide();
     ...
     document.body.innerHTML = originalContents;
		...
		<a href="quick_select_products.php?hs_id=<?php echo @$_REQUEST['hs_id']; ?>&pc_admin_id=<?php echo @$_REQUEST['pc_admin_id']; ?>&Photographer_id=<?php echo @$_REQUEST['Photographer_id']; ?>&od=<?php echo @$_REQUEST['od']; ?>&u=1" id="thirdStep"><i class="fa fa-database" style="font-size:30px;padding-top:10px;"></i>
			<span class="breadcrumb__inner">
...
<div class="breadcrumb1 hidden-md hidden-lg hidden-xl" style="height:50px;">
		...
		<a href="quick_select_products.php?hs_id=<?php echo @$_REQUEST['hs_id']; ?>&pc_admin_id=<?php echo @$_REQUEST['pc_admin_id']; ?>&Photographer_id=<?php echo @$_REQUEST['Photographer_id']; ?>&od=<?php echo @$_REQUEST['od']; ?>&u=1" id="thirdStep">
			<span class="breadcrumb__inner">
      ...
      <div class="col-md-12">
       ...
       <?php }else{?>
        ...
        <td align="right" style="font-size:10px;" adr_trans="">Photographer Name</td><td style="padding-left:5px;padding-right:15px;">:</td><td><?php if($get_summary['photographer_id']!=0){echo $photographer_Name;} else{echo 'Not yet selected';}?></td>
				...
				<tr>
				<td align="right" style="font-size:10px;vertical-align: baseline;" id="label_session_date_time" adr_trans="label_session_date_time">Session Date & Time</td><td style="padding-left:5px;padding-right:15px;vertical-align: baseline;">:</td><td><?php if($get_summary['session_from_datetime']!='0000-00-00 00:00:00') { echo date("d-m-Y H:i a",strtotime($get_summary['session_from_datetime'])); ?>
...
<table class="" style="color:#000;font-weight:600;font-size:13px;">
      ...
      $propAddress=$get_summary['property_address']." ".$get_summary['property_zip']." ".$get_summary['property_city']." US ";  
