                ...
                <div class="col-md-6">
  						...
  						<div class="col-md-6">
  						 ...
  						 <div class="col-md-6">
                                  ...
                                  <input id="zip" name="zip" placeholder="Zip code" type="text" maxlength="12" autocomplete="off" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control form-value" required="" value="<?php echo $get_profile1['postal_code']; ?>">
                              </div>
