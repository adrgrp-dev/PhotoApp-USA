...
Your account has been approved by our ADR's Photo App Admin team.<br>
<a href='{{project_url}}' target='_blank'>click here</a> to login to your ADR's Photo App account.<br>
Thank you for choosing ADR's Photo App! We look forward to saving you time by simplifying your real-estate photography experience.<br>
Know someone else that might benefit from using ADR's Photo App? login to invite other real-estate agents or PhotoCompany into our community.<br>

Your account has been approved by ADR's Photo App Admin Team.<br>{{Instructions}}
...
$Instructions="<br>As a Photo Company, Kindly do all the below steps to continue using ADR's Photo App.<br><br>
