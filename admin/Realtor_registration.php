...
{{PC_Organisation_Name}} has created you as a {{Type_of_user}} with ADR's Photo application .<br>
To register with ADR's Photo App please follow the options below, <br />
<br><br>
           ...
           <input id="org_no" name="org_no" placeholder="Organization contact number" type="tel" pattern="[0-9+.\(\)\-\s+]*" min="1" autocomplete="off" class="form-control form-value" required="">
						...
						<div class="col-md-6">
						 ...
						 <div class="col-md-6">
                                ...
                                <input id="zip" name="zip" id="zip" placeholder="Zip code" type="text" maxlength="12"
