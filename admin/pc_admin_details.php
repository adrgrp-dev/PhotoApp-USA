	...
	<tr><td colspan="3" style="padding-top:10px;"><h5 class="text-center" id="label_admin_user_details" adr_trans="label_admin_user_details" >Admin user details</h5></td></tr>   
	   ...
	   <tr><td align="right" id="first_td"  style="font-size: 10px;width:200px"><img src="data:<?php echo @$res1['profile_pic_image_type']; ?>;base64,<?php echo base64_encode(@$res1['profile_pic']); ?>" width="70" height="70" style="border-radius:35px" /><br /></td><td style="padding-left:5px;padding-right:15px;">&nbsp;</td><td align="left" style="font-size:20px;"><?php echo @$res1['first_name']." ".$res1['last_name']; ?>
         ...
         <p align="center" style="margin-top:10px;">
				...
				<a id="label_approve" adr_trans="label_approve" class="anima-button circle-button adr-save btn-sm btn" href="pc_admin_details.php?approve=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-check"></i>Approve</a> <?php }  else { ?>
								<a id="label_block" adr_trans="label_block" class="anima-button circle-button adr-cancel btn-sm btn" href="pc_admin_details.php?block=1&id=<?php echo $res1['id']; ?>"><i class="fa fa-ban"></i>Block</a><?php } ?>
								...
								?>
									...
									<a id="label_back_users_list" adr_trans="label_back_users_list" class="anima-button circle-button btn-sm btn adr-save" href="csr_list1.php"><i class="fa fa-sign-in"></i>Back to users list</a>
								<?php }
				if(@$_REQUEST['val'] == 1) {
					?>
