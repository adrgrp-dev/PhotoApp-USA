...
<div class="col-md-6">
     ...
     <div class="col-md-6">
                        ...
                        <input id="property_zip" name="property_zip" placeholder="Zip code" type="text" maxlength="12"
 autocomplete="off" class="form-control form-value"   required="" value="<?php echo @$order_fetch['property_zip']; ?>" readonly>
                    </div>
    ...
    <div class="col-md-6">
      ...
      <select name="property_country" class="form-control form-value" required="" <?php if(@$_REQUEST['edit']) { echo "readonly"; } ?>>
          ...
          <div class="col-md-6">
                              ...
                              <input id="property_contact_email" name="property_contact_email" onblur="this.value=this.value.trim()" placeholder="Enter The email id" type="email"   autocomplete="off" class="form-control form-value"  value="<?php echo @$order_fetch['property_contact_email']; ?>" <?php if(@$_REQUEST['edit']) { echo "readonly"; } ?>>
                              <br>
                          </div>
