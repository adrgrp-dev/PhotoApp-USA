...
In order to check your discounted rates, please check the Products tab after selecting ".$_SESSION['admin_loggedin_org']." in the ADR's Photo application.
...
<div class="col-md-4" style="border-radius:0px 5px 5px 0px;border:solid 1px;font-weight:600;padding:10px;"><a href="PhotographerProducts.php">Photographers Commission</a></div>
</div>
</center>
<br><br><br />
...
$realtorDiscountPrice=0;
	...
	$realtorRate=mysqli_query($con,"select * from realtor_product_cost where pc_admin_id='$loggedin_id' and realtor_id='$realtor_id' and product_id='$proID'");
				   ...
				   <?php
					if(@$_REQUEST['realtor']) { ?>
				 <tr><td colspan="4">&nbsp;</td><td><input type="submit" name="Save" value="Set Price" class="btn adr-save btn-sm"></td></tr>
				 <?php } ?>
                </tbody>
				</form>
            </table></div>
