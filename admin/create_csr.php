...
{{secret_code}}<br><br><span style=\"font-size:10px;font-weight:bold;\">*This is an auto generated email notification from ADR's Photo App. Please do not reply back to this email. For any support please write to info@adrgrp.com</span><br><br>
Thanks,<br>
...
<?php include "header.php";  ?>
	<div class="bgimage8" data-sub-height="238">
            <div class="row">
	...
	<input id="email" name="email" placeholder="Email" type="email" autocomplete="off"  onblur="this.value=this.value.trim();validate_email(this.value)" class="form-control form-value" required="">
  						...
  						<div class="col-md-6">
  						 ...
  						 <div class="col-md-6">
                                  ...
                                  <input id="zip" name="zip" placeholder="Zip code" type="text" maxlength="12" autocomplete="off" class="form-control form-value" value="<?php echo $get_profile1['postal_code']; ?>" required="" >
                              </div>
