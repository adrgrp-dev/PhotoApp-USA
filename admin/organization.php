              ...
              <div class="navbar navbar-main over">
                  <div class="container">
                      <div class="navbar-header">
                          ...
                          <a class="navbar-brand" href="../index.php" style="padding-left:30px;"><img src="../images/logo.png" alt="logo" style="margin-top:-6px;width:65px;height:60px">
                  ...
                  <div class="col-md-12 text-center box-middle">
                      <div>
                          ...
                          <hr class="space m">
                            ...
                            <span > Welcome to ADR's Photo App world! </span> <br />
                            <span >You can login to ADR's Photo App and <?php if($_REQUEST['typeofuser']=="Realtor"){ echo "book a photography session for your property.";}else{ echo "avail application features.";} ?></span>
