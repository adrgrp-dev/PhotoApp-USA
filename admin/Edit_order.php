...
$update_homeseller=mysqli_query($con,"UPDATE `home_seller_info` SET `name`='$sell_name',`address`='$address',`mobile_number`='$mobile_no',`email`= ' $email_id ',`city`='$city',`state`='$state',`country`='US',`zip`='$zip',`reference_number`='$ref_no',`contact_person_name`='$name',`contact_person_mobile`='$mobile_no1',`contact_person_email`='$email_id1',`notes`=' ' where id='$home_sell_id'");
...
$insert_action=mysqli_query($con,"INSERT INTO `user_actions`( `module`, `action`, `action_done_by_name`, `action_done_by_id`, `Realtor_id`,`action_date`) VALUES ('Order','Updated','$loggedin_name',$loggedin_id,$loggedin_id,now())");
            ...
            if($_SESSION["admin_loggedin_type"]!='SubCSR') {
             header("location:superOrder_detail.php?id=".$id_url."&a=1#home");
 ...
 <div class="section-empty">
	...
	<?php include "sidebar.php"; ?>
      ...
      <div class="col-md-10" style="padding-top:30px;">
           ...
           <h3 class="text-center" style="" id="label_edit_order" adr_trans="label_edit_order" >Edit Order</h3>
           <hr class="space s" />
           <?php if(@isset($_REQUEST["st"])) { ?>
                        <div class="success-box" style="display:block;">
                            <div class="text-success" id="label_msg_sent" adr_trans="label_msg_sent"><i>Congratulations. Your message has been sent successfully</i></div>
                        </div>
           <?php } ?>
    ...
    <div class="col-md-6">
      ...
      <select name="country" class="form-control form-value"  value="<?php echo  $get_homeseller[''];?>" required="">
          ...
          <div class="col-md-12" >
          <h4 id="label_cnt_person" adr_trans="label_cnt_person"><b> CONTACT PERSON</b></h4>
