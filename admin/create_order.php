...
?>
    ...
    <div class="col-md-6">
     ...
     <div class="col-md-6">
                        ...
                        <input id="zip" name="zip" placeholder="Zip code" type="text" maxlength="12" autocomplete="0" class="form-control form-value"  value="<?php echo  @$appointment_update_details['zip'];?>" required=""   >
                    </div>
