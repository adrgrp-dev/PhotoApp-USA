...
background: repeating-linear-gradient(
    ...
    function get_states(cityIs)
 {
  ...
  var split=this.responseText;
    document.getElementById("property_state").innerHTML = split;
    }
...
<div class="col-md-6">
     ...
     <div class="col-md-6">
                        ...
                        <input id="property_zip" name="property_zip" placeholder="Zip code" type="text" maxlength="12" autocomplete="off" class="form-control form-value" readonly required="" value="<?php echo @$order_fetch['property_zip']; ?>"  >
                    </div>
