...
$rootPath = realpath("./temp/$timeRandom");
 $zip_file = "ADRPhotoApp_".$property_city."_".$property_state."_Order_".$id_url."_".$timeRandom.".zip";
            ...
            <div class="navbar navbar-main over">
                <div class="container">
                    <div class="navbar-header">
                      ...
                      <p align="center" style="font-size: x-large;color: #000;margin-top: 10px;margin-right: 110px;">Welcome to ADR's Photo App</p>
