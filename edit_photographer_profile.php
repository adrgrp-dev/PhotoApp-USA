...
mysqli_query($con,"insert into photographer_profile(photographer_id)values('$loggedin_id')");
...
if($_FILES['profile_pic']['size'] == 0) {
	...
	mysqli_query($con,"update photographer_profile set contact_number='$contact_number',address_line1='$address_line1',address_line2='$address_line2',city='$city',state='$state',postal_code='$zip',country='$country',first_name='$fname',last_name='$lname',about_me='$about_me',skills='$skills',portfolio='$portfolio' where photographer_id='$loggedin_id'");

  mysqli_query($con,"update user_login set contact_number='$contact_number',address_line1='$address_line1',address_line2='$address_line2',city='$city',state='$state',postal_code='$zip',country='$country',first_name='$fname',last_name='$lname' where id='$loggedin_id'");

  $insert_action=mysqli_query($con,"INSERT INTO `user_actions`( `module`, `action`, `action_done_by_name`, `action_done_by_id`,`action_done_by_type`, `photographer_id`,`action_date`) VALUES ('Profile','Updated','$loggedin_name',$loggedin_id,'Photographer',$loggedin_id,now())");
 ...
 mysqli_query($con,"update photographer_profile set contact_number='$contact_number',address_line1='$address_line1',address_line2='$address_line2',city='$city',state='$state',postal_code='$zip',country='$country',first_name='$fname',last_name='$lname',profile_pic='$imgData1',profile_pic_image_type='$imageType1',about_me='$about_me',skills='$skills',portfolio='$portfolio' where photographer_id='$loggedin_id'");
  ...
  mysqli_query($con,"update user_login set contact_number='$contact_number',address_line1='$address_line1',address_line2='$address_line2',city='$city',state='$state',postal_code='$zip',country='$country',first_name='$fname',last_name='$lname',profile_pic='$imgData1',profile_pic_image_type='$imageType1' where id='$loggedin_id'");
...
header("location:photographer_profile.php?u=1");
}
?>
...
<?php if(@$_REQUEST['first']) { ?><div class="col-md-12"><h5 align="center" id="label_add_company_profile" style="color:#006600!important;font-size:13px;">Welcome to ADR's Photo App!<br />Its mandatory to complete the profile information to understand you better</h5></div> <?php } ?>
  ...
  <div class="col-md-6">
              ...
              <?php } ?>
               ...
               <div class="col-md-6">
                                  ...
                                  <input id="zip" name="zip" type="text" maxlength="12" autocomplete="off" class="form-control form-value"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  required=""  value="<?php echo @$res1['postal_code']; ?>">
                              </div>
