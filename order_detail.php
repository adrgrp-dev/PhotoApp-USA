...
$xyz123=0;
  ...
  The pictures for {{order#}} are completed and can be access via our ADR's Photo App app
  <a href='{{link}}'
  target='_blank'>Click here</a>.<br>
  Thank you for choosing ADR's Photo App! 
...
Order with Assignment No. #{{order no}} has been cancelled by the realtor {{realtor name}}<br><br><span style=\"font-size:10px;font-weight:bold;\">*This is an auto generated email notification from ADR's Photo App. Please do not reply back to this email. For any support please write to info@adrgrp.com</span><br><br>
Thanks,<br>
ADR's Photo App Team.
";
...
<br/><br/>
<p align="right" ><a href="paynow_summary.php?id=<?php echo $id_url; ?>" class="btn btn-default btn-sm adr-save">Pay Now</a></p>
				</div> 
