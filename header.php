        ...
        <div class="navbar navbar-default over wide-area" role="navigation">
            <div class="navbar navbar-main over">
                ...
                <a class="navbar-brand" href="<?php echo $page; ?>" style="padding-left:30px;">
				 <img src="images/logo.png" width="120" height="130">
				</a>
                    </div>
...
$detailsOdUser1=mysqli_fetch_array($detailsOdUser);
				  ...
				  <li><a href="cms.php?id=1"><i class="fa fa-camera-retro" style="padding-right:10px;"></i>About ADR's Photo App</a></li>
...
?> <button type="button" class="navbar-toggle">
				...
				<img src="images/logo.png"  width="120" height="130" alt="logo"  class="hidden-sm hidden-xs">
				
				<img src="images/logo.png"  width="120" height="130" alt="logo"  class="hidden-md hidden-lg hidden-xl">
